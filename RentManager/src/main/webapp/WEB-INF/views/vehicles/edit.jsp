    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <a class="btn btn-danger" href="${pageContext.request.contextPath}/cars">
                    retour
                </a>
              </c:if>
            </h1>
                    ...
                    <div class="box">
                        ...
                        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/cars/edit">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <c:forEach items = "${vehicles}" var = "vehicle">
                                        <c:if test="${vehicle.id == vehicleid}">
                                ...
                                <div class="form-group">
                                  <div class="col-sm-10">
                                       <input type="hidden" class="form-control" id="idvehicle" name="idvehicle" value="${vehicleid}">
                                   </div>
                                </div>
                                <!--
                                <div class="form-group">
