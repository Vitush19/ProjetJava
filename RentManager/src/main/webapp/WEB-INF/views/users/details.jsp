...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                                        ...
                                        <c:forEach items = "${rent_info}" var = "rent">
                                          <tr>
                                            ...
                                            <c:forEach items = "${vehicles}" var = "vehicle">
                                              <c:if test="${rent.vehicle_id == vehicle.id}"><td>${vehicle.constructeur} ${vehicle.modele}</td></c:if>
                                            </c:forEach>
                                            <td>${rent.debut}</td>
                                            <td>${rent.fin}</td>
                                          </tr>
            ...
            <!-- /.row -->
            <div >
              <a class="btn btn-danger pull-right" href="${pageContext.request.contextPath}/users">
                  Retour
              </a>
            </div>
        </section>
